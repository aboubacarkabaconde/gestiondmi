...
# 7. Exposer le port Django
EXPOSE 8000

# Commande de lancement
CMD ["sh", "-c", "python manage.py migrate && python manage.py collectstatic --noinput && gunicorn pme_manager.wsgi:application --bind 0.0.0.0:8000"]
